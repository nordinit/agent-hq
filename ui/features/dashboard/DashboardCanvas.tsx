...
function Section({ section, index, ...props }: Props & { section: DashboardSection; index: number }) {
  ...
  // The getting-started tour spotlights the leading section: the summary cards on the overview.
  return <section className={styles.section} data-tour-target={index === 0 ? 'dashboard-overview' : undefined}>
