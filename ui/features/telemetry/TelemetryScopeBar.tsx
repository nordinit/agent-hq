...
export default function TelemetryScopeBar({ catalog, filters, onChange }: { catalog: TelemetryCatalog | null; filters: TelemetryFilters; onChange: (next: TelemetryFilters) => void }) {
  const { scope } = filters;
