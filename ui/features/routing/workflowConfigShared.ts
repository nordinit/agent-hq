...
export const TRANSITION_COLUMN_HELP = {
  ...
  priority: 'Which matching transition wins when more than one rule could apply. Higher numbers win; ties break toward the lower row ID.',
...
export const ROUTING_RULE_COLUMN_HELP = {
  ...
  priority: 'Which matching assignment rule wins when more than one rule could apply. Higher numbers win; ties break toward the lower row ID.',
...
export const REQUIREMENT_COLUMN_HELP = {
  ...
  priority: 'The order requirements are evaluated in when several checks apply. Higher numbers are checked first; ties break toward the lower row ID.',
