      ...
      Task: {
        ...
        properties: {
          ...
          custom_fields: {
            ...
            nullable: true,
            additionalProperties: true,
            description: 'Workflow-defined task fields, including lifecycle evidence such as review_commit or qa_verified_commit when configured by the resolved field schema.',
          },
      ...
      TaskOutcomeRequest: {
        ...
        properties: {
          ...
          payload: {
            type: 'object',
            additionalProperties: true,
            description: 'Workflow-defined evidence and custom task fields, for example review_commit or qa_verified_commit when configured by the resolved field schema.',
          },
        },
        additionalProperties: true,
      },
