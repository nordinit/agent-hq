...
export function registerTasksTools(ctx: McpDomainContext) {
  ...
  registerTool(
    ...
    ({ task_id, status, summary, review_branch, review_commit, review_url, qa_verified_commit, qa_tested_url, merged_commit, deployed_commit, deploy_target, deployed_at, live_verified_by, live_verified_at, failure_detail, dry_run }) =>
      wrap(() =>
